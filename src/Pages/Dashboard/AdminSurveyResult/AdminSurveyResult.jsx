...
const AdminSurveyResult = () => {
  ...
  useEffect(() => {
    axiosSecure.get(`/survey/sortByTotalVote`).then((res) => {
      setSurvey(res.data);
      setisLoading(false);
    });
  }, [axiosSecure]);
...
if (isLoading) {
  ...
  return (
    <div>
      <h2 className="text-4xl font-bold text-center my-10 text-blue-800 dark:text-blue-400 font-serif">
...
{surveys.length==0? <h3 className="text-center my-12 min-h-screen text-lg font-medium text-slate-700 dark:text-slate-300">No survey has been created yet. </h3>:""}
      ...
      <div className=" overflow-x-auto  pb-4">
          <div className="min-w-full inline-block align-middle">
              <div className="overflow-hidden  border rounded-lg border-blue-300 dark:border-slate-300">
                  <table className="table-auto min-w-full rounded-xl">
                      <thead>
                          <tr className="bg-blue-300 dark:bg-slate-300">
                          <th scope="col" className="p-5 border text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> # </th>
                              ...
                              <th scope="col" className="p-5 border text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">Surveyor Email </th>
                      ...
                      {surveys.map((item, index) => (
                          <tr key={item._id} className="bg-blue-50 dark:bg-slate-600 transition-all duration-500 hover:bg-sky-200 dark:hover:bg-slate-800">
                              ...
                              <td className="p-5 border whitespace-nowrap text-sm leading-6 font-medium text-gray-900 dark:text-white"> {item.loggedUser} </td>
      ...
      {isLoading?(<div className="flex justify-center items-center h-screen ">
        ...
        <div className=" ">
           <h2 className="text-2xl font-bold text-blue-700 dark:text-white mt-8 text-center font-serif">
        Survey Results
    </h2>
