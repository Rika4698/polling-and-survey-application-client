...
<div className="relative ">
      ...
      <div
        className={`fixed top-0 left-0 bottom-0 w-2/3 sm:w-1/2 bg-white dark:bg-gray-800 lg:h-full min-[350px]:h-screen overflow-y-auto z-50 p-6  transition-transform duration-300  ${
