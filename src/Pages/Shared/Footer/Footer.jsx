        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                ...
                <div className="lg:mx-auto text-center ">
                    <h4 className="text-lg text-gray-900 font-medium mb-7 dark:text-gray-300">Quick Links</h4>
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><Link to="/"  className="text-gray-600 hover:text-gray-900 hover:font-medium dark:text-gray-200">Home</Link></li>
                        <li className="mb-6"><Link to="/about"  className=" text-gray-600 hover:text-gray-900 hover:font-medium dark:text-gray-200">About Us</Link></li>
                        <li><Link to="/pro"  className=" text-gray-600 hover:text-gray-900 hover:font-medium dark:text-gray-200">Pro-User</Link></li>
                    </ul>
                </div>
                ...
                <div className="lg:mx-auto text-center ">
                    <h4 className="text-lg text-gray-900 font-medium mb-7 dark:text-gray-300">Support</h4>
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-gray-600 hover:text-gray-900 hover:font-medium dark:text-gray-200">Customer Support</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900 hover:font-medium dark:text-gray-200">Terms & Conditions</a></li>
                        <li ><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900 hover:font-medium dark:text-gray-200">Privacy Policy</a></li>
                    </ul>
                </div>
            
                <div className="lg:mx-auto text-center ">
                    <h4 className="text-lg text-gray-900 font-medium mb-7 dark:text-gray-300">Subscribe</h4>
                    <p className="text-sm text-gray-500 leading-6 mb-7  dark:text-gray-400">Subscribe to get the latest news from us</p>
                    <a href="javascript:;"  className="mx-auto flex items-center justify-center gap-2 border border-indigo-600 rounded-full py-3 px-6 w-fit lg:mx-10  text-sm text-indigo-600 font-semibold transition-all duration-500 hover:bg-indigo-50 dark:border-indigo-500 dark:text-indigo-400">Subscribe<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
